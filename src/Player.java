...
public class Player {
	...
	{	
		...
		//PRINT RESULT
		System.out.println("# "+this.team+"["+this.row+"]"+"["+this.position+"]"+" {"+this.type+"}"+" Attacks "+target.team+"["+target.row+"]"+"["+target.position+"]"+" {"+target.type+"}");
	...
	public void heal(Player target){
		...
		System.out.println("# "+this.team+"["+this.row+"]"+"["+this.position+"]"+" {"+this.type+"}"+" Heal "+target.team+"["+target.row+"]"+"["+target.position+"]"+" {"+target.type+"}");
		}
	}
	...
	public void doubleSlash(Player target){
		...
		System.out.println("# "+this.team+"["+this.row+"]"+"["+this.position+"]"+" {"+this.type+"}"+" Double-Slashes "+target.team+"["+target.row+"]"+"["+target.position+"]"+" {"+target.type+"}");
	}
	...
	public void curse(Player target){
		...
		target.cursed = true;
		System.out.println("# "+this.team+"["+this.row+"]"+"["+this.position+"]"+" {"+this.type+"}"+" Curses "+target.team+"["+target.row+"]"+"["+target.position+"]"+" {"+target.type+"}");
	}
	...
	public void revive(Player target){
		...
		System.out.println("# "+this.team+"["+this.row+"]"+"["+this.position+"]"+" {"+this.type+"}"+" Revives "+target.team+"["+target.row+"]"+"["+target.position+"]"+" {"+target.type+"}");
	}
