...
public class StudentTester {
	...
	public static void bonusCredit()
	{
		...
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Phoenix, Arena.Row.Front, 4);
		...
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.BlackMage, Arena.Row.Back, 4);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.BlackMage, Arena.Row.Back, 5); //24Turns
		//////////////////////////////////////////////////////////////////////////////////
	...
	/*	battleField.addPlayer(Arena.Team.A, Player.PlayerType.Tank, Arena.Row.Front, 1);
		...
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Samurai, Arena.Row.Back, 2);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Phoenix, Arena.Row.Back, 3);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.BlackMage, Arena.Row.Back, 4);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.BlackMage, Arena.Row.Back, 5); //29Turns*/
//////////////////////////////////////////////////////////////////////////////////
		...
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.Tank, Arena.Row.Front, 2);
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.Tank, Arena.Row.Front, 3);
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.Phoenix, Arena.Row.Front, 4);
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.BlackMage, Arena.Row.Front, 5);
		
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.Samurai, Arena.Row.Back, 1);
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.Samurai, Arena.Row.Back, 2);
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.Healer, Arena.Row.Back, 3);
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.Healer, Arena.Row.Back, 4);
		battleField.addPlayer(Arena.Team.B, Player.PlayerType.Samurai, Arena.Row.Back, 5);
		//////////////////////////////////////////////////////////////////////////////
